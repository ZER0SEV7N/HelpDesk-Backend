...
import { ClienteFilterParamDTO } from '../dto/cliente-filter-param.dto';
...
export class ClientesController {
  ...
  async findAll(@Query() params: ClienteFilterParamDTO) {
    return this.findAllClientesUseCase.execute(params);
  }
